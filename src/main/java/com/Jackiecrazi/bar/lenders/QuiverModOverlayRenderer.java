...
import com.Jackiecrazi.bar.ConfigofJustice;
            ...
            if (mc != null) {
                ...
                if (player != null) {
                    ...
                    if (selectedArrowItemIndex >= 0 && selectedArrowItemIndex < arrowTypeList.size()) {
                        ...
                        if (selectedArrowItemIndex < 0) selectedArrowItemIndex = 0;
                    ...
                    if (quiverCount > 0 && (RepetitiveSnippets.hasQuiver(player))) {
                        ...
                        if (selectedQuiverSlots.size() > 0) {
                            ...
                            if (firstSlotIndex == -1) {
                                ...
                                firstSlotIndex = MathHelper
                                    .clamp_int(firstSlotIndex, slotsOnHalfScreen, quiverSlotCount - slotsOnHalfScreen);
                                firstSlotIndex -= quiverSlotCount / 2; // Center
                            }

                            int targetOffset = (firstSlotIndex * 19) + (firstSlotIndex / QuiverInventory.size); // (firstSlotIndex
                                                                                                                // /
                                                                                                                // QuiverInventory.size)
                                                                                                                // is
                                                                                                                // for
                                                                                                                // pixels
                                                                                                                // between
                        ...
                        if (fadeTimer > 0) {
                            ...
                            else if (fade < 4) fade = 4;

                            GL11.glEnable(GL11.GL_BLEND);
                            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
                            fontRenderer.drawStringWithShadow(
                                infoText,
                                (w - fontRenderer.getStringWidth(infoText)) / 2,
                                23,
                                16777215 + (fade << 24));
                            GL11.glDisable(GL11.GL_BLEND);
                        ...
                        if (animationStyle == 0 && selectedQuiverSlots.size() > 0) {
                            ...
                            if (switchAnimation > 0) {
                                ...
                                if (switchAnimation < 0) switchAnimation = 0;
                            }
                        }
                        ...
                        for (ItemStack quiverStack : quiverStacks) {
                            ...
                            for (int i = 0; i < quiverInventory.size; i++) {
                                ...
                                if (selected) drawTexturedModalRect(x, y, 57 + texOffset, 38, 19, 19);
                                else drawTexturedModalRect(x, y, texOffset, 38, 19, 19);
                                ...
                                if (hasArrowStack) {
                                    ...
                                    if (animationStyle == 0) {
                                        ...
                                        GL11.glTranslatef(
                                            0,
                                            -Math.min(
                                                (switchAnimationLength - switchAnimation) * 2F
                                                    / (float) switchAnimationLength,
                                                2),
                                            0);
