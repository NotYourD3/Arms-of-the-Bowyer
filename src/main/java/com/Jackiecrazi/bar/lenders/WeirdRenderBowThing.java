...
import com.Jackiecrazi.bar.Items.QuiverBow;
import com.Jackiecrazi.bar.Items.arrows.IArrowIcons;
...
public class WeirdRenderBowThing implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack bowStack, Object... data) {
        ...
        if (type.equals(ItemRenderType.INVENTORY)) {
            ...
            if (arrowStack == null) arrowStack = new ItemStack(ModItems.DerpArrow);

            Item arrowItem = arrowStack.getItem();

            iconOffset = bow.getIconOffset(usePower);

            if (usePower > 0 && arrowItem instanceof IArrowIcons) fullBright = BowArrowIcons.getFullBright(
                bow.getBowArrowIconName(),
