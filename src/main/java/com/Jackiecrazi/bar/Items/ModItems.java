...
public class ModItems {
    ...
    public static Item FireArrow = new ItemQuiverModArrow().setFrameCount(3)
        .setUnlocalizedName("firearrow")
        .setTextureName("quivermod:firearrow");
    public static Item DerpArrow = new ItemQuiverModArrow().setUnlocalizedName("arrow")
        .setTextureName("quivermod:arrow");
    public static Item PotArrow = new PotionArrow().setUnlocalizedName("potionarrow")
        .setTextureName("quivermod:potionarrow");
    public static Item EnderArrow = new ItemQuiverModArrow().setUnlocalizedName("enderarrow")
        .setTextureName("quivermod:enderarrow");
    public static Item ImpactArrow = new ItemQuiverModArrow().setUnlocalizedName("impactarrow")
        .setTextureName("quivermod:impactarrow");
    public static Item TimedArrow = new ItemQuiverModArrow().setUnlocalizedName("timedarrow")
        .setTextureName("quivermod:timedarrow");
    public static Item SplashArrow = new ItemQuiverModArrow().setUnlocalizedName("splashpotionarrow")
        .setTextureName("quivermod:splashpotionarrow");
    public static Item DrillArrow = new DrillArrow().setUnlocalizedName("drillarrow")
        .setTextureName("quivermod:drillarrow");
    public static Item TorchArrow = new ItemQuiverModArrow().setUnlocalizedName("torcharrow")
        .setTextureName("quivermod:torcharrow");
