...
import com.Jackiecrazi.bar.Items.SplittingArrowDefaults;
...
public class PotionArrow extends ItemPotion implements IArrowIcons, IArrowItem, ISplittingArrow {
    ...
    public IIcon getIconFromDamageForRenderPass(int damage, int pass) {
        if (pass > 1 && isSplittingArrow(damage)) return ItemQuiverModArrow.splittingArrowIIcon;
    ...
    public void getSubItems(Item itemID, CreativeTabs creativeTabs, List par3List) {
        ...
        Iterator iter = effectToSubItemMap.values()
            .iterator();
        ...
        iter = effectToSplittingSubItemMap.values()
            .iterator();
    ...
    public String getItemDisplayName(ItemStack stack) {
        ...
        if (stack.getItemDamage() == 0) {
            ...
            if (effects != null && !effects.isEmpty()) {
                ...
                nameUnloc += ".postfix";
                out += prefix + StatCollector.translateToLocal(nameUnloc)
                    .trim();
            } else {
                String nameUnloc = PotionHelper.func_77905_c(stack.getItemDamage());
                out += StatCollector.translateToLocal(nameUnloc)
                    .trim() + " "
