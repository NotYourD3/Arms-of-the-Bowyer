...
public class DrillArrow extends ItemQuiverModArrow {
    ...
    public String getItemDisplayName(ItemStack stack) {
        return (isBroken(stack.getItemDamage()) ? StatCollector.translateToLocal("quiverModArrow.prefix.broken") + " "
            : "") + super.getItemDisplayName(stack);
    }
    ...
    public IIcon getIconFromDamageForRenderPass(int damage, int pass) {
        ...
        if (pass == 1 && !isBroken(damage)) return drillHeadIcon;
        else return splittingArrowIIcon;
    }
