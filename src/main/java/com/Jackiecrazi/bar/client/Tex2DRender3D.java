package com.Jackiecrazi.bar.client;
...
public class Tex2DRender3D {
    ...
    public static void render(boolean fancy, float left, float top, float right, float bottom, int texWidth,
        int texHeight, float thickness) {
