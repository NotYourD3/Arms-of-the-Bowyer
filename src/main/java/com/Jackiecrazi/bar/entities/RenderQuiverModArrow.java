 ...
 * };
 * public static final ResourceLocation brokenDrillArrowLoc = new ResourceLocation(arrowTexturesPath +
 * "drillbroken.png");
 * public static final ResourceLocation potionArrowInnerLoc = new ResourceLocation(arrowTexturesPath +
 * "potioninner.png");
 * public static final ResourceLocation potionArrowOuterLoc = new ResourceLocation(arrowTexturesPath +
 * "potionouter.png");
 * public static final ResourceLocation splashPotionArrowInnerLoc = new ResourceLocation(arrowTexturesPath +
 * "splashpotioninner.png");
 * public static final ResourceLocation splashPotionArrowOuterLoc = new ResourceLocation(arrowTexturesPath +
 * "splashpotionouter.png");
 ...
 * //ItemRenderer.renderItemIn2D(tessellator, arrowRight, arrowTop, arrowLeft, arrowBottom, texSize.width,
 * texSize.height, px);
 ...
 * GL11.glPushMatrix();
 * GL11.glRotatef(arrow.prevRotationYaw + (arrow.rotationYaw - arrow.prevRotationYaw) * partialTick - 90.0F, 0.0F, 1.0F,
 * 0.0F);
 ...
 * vertRotMult = modArrow.prevFireVerticalRot + (vertRotMult - modArrow.prevFireVerticalRot) * (0.05F / (modArrow.slowMo
 * > 0 ? modArrow.slowMo : 1));
 ...
 *//**
    * Renders the entity's shadow and fire (if its on fire). Args: entity, x, y, z, yaw, partialTickTime
    *//*
       * public void doRenderShadowAndFire(Entity par1Entity, double par2, double par4, double par6, float par8, float
       * par9)
       * {
