...
public class BowArrowIcons {
    ...
    public static void register(String bowName, String specialArrowName, IIconRegister iconRegister, int frames) {
        String name = "quivermod:bowarrowicons/" + bowName;

        HashMap<String, Object> specialArrowMap = iconArrayMap.get(bowName);

        if (specialArrowMap == null) specialArrowMap = new HashMap();
        ...
        if (arrow.getItem() instanceof IArrowIcons) {
            ...
            switch (pass) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (splitting) icons = bowArrowIconMap.get("splittingarrow");
                    break;
            }
