    ...
    public static TextureSize getSize(ResourceLocation textureLocation, int defaultW, int defaultH) {
        ...
        if (size == null) {
            ...
            try {
                ...
                BAR.log(
                    "An error occurred getting the size of a texture. Please post this log on the Better Archery Reborn thread on the Minecraft forums.");
                e.printStackTrace();
                size = null;
            }
        }
        ...
        else return new TextureSize(defaultW, defaultH);
    }
